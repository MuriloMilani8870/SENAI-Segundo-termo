        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Fornecedores>(entity =>
            {
                ...
                entity.HasIndex(e => e.Cnpj)
                    .HasName("UQ__Forneced__AA57D6B4AFCD3A4F")
                    .IsUnique();

                entity.HasIndex(e => e.RazaoSocial)
                    .HasName("UQ__Forneced__448779F0906BD886")
                    .IsUnique();

                entity.HasIndex(e => e.UsuarioId)
                    .HasName("UQ__Forneced__2B3DE7B9B8360398")
                    .IsUnique();
            ...
            modelBuilder.Entity<Pecas>(entity =>
            {
                ...
                entity.HasIndex(e => e.Codigo)
                    .HasName("UQ__Pecas__06370DACBCFA276F")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuarios__A9D1053495989F79")
                    .IsUnique();
